...
import { logout, selectLoggedInUser } from '../../pages/Authentication/Redux/AuthSlice';
import { useDispatch, useSelector } from 'react-redux';
import { logoutHandle, selectStudentProfile } from '../../pages/Form/Redux/FormSlice';
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="h-12 w-12 rounded-full ">
              <img
                src={
                  studentData?.data?.photo ? studentData?.data?.photo : UserOne
                }
                alt="User"
          ...
          >
            {user?.data?.role === 'student' && (
              <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-4 dark:border-strokedark">
                <li>
                  <Link
                    to="/student-profile"
                    className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base dark:hover:dark:text-[#FDE4D0]"
                  >
                    <svg
            ...
            <button
              className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base dark:hover:dark:text-[#FDE4D0]"
