...
const DatePickerOne = ({ title, name, register, defaultValue }) => {
  ...
  useEffect(() => {
    ...
    flatpickr('.form-datepicker', {
      ...
      dateFormat: 'Y-m-d', // Changed the dateFormat to match the format of the registered field
      prevArrow:
      ...
      onChange: function (selectedDates, dateStr, instance) {
        ...
        register(name).onChange(dateStr);
      },
    });
  }, [register, name]);
    ...
    <div>
      ...
      <div className="relative">
        <input
          ...
          type="text" // Change the type to text since flatpickr will handle the date selection
        />
