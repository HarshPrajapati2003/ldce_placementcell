...
import { loginUserAsync, selectLoggedInUser } from '../../pages/Authentication/Redux/AuthSlice';
import axios from 'axios';
import { fetchStudentDataAsync } from '../../pages/Form/Redux/FormSlice';
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={DarkLogoNew} alt="Logo" width="100%"/>
        </NavLink>
        <button
          ref={trigger}
        ...
        <nav className="px-4 lg:px-6">
          ...
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/* <!-- Menu Item Recruitment Process--> */}
              <li>
                <NavLink
                  to="/recruitment-process"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('recruitment-process') &&
              ...
              {/* <!-- Menu Item Rules and Regulations--> */}
              <li>
                <NavLink
                  to="/rules"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
              ...
              {/* <!-- Menu Item Application Form--> */}
              {user?.data?.role === 'student' || !user ? (
                <li>
                  <NavLink
              ...
              {/* <!-- Menu Item Recent Companies --> */}
              {user?.data?.role === 'student' || !user ? (
                <li>
                  <NavLink
                    to="/recent-companies"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('recent-companies') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
              ...
              {/* <!-- Menu Item All Companies --> */}

              {/* <!-- Menu Item Student Profile --> */}
              {user?.data?.role === 'student' || !user ? (
                <li>
                  <NavLink
                    to="/student-profile"
                ...
                <li>
                  <NavLink
                    to="/verify-student"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('verify-student') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
              ...
              {/* <!-- Menu Item Verify Student --> */}

              {/* <!-- Menu Item Placement Statistics--> */}
              <li>
                <NavLink
                  to="/placement-statistics"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes('placement-statistics') &&
                    'bg-graydark dark:bg-meta-4'
                  }`}
                >
                  <svg
