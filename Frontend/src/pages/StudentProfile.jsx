            ...
            <div className="bg-white dark:border-strokedark dark:bg-boxdark rounded-lg shadow-xl pb-8">
              ...
              <div className="flex-1 flex flex-col items-center lg:items-end justify-end px-8 mt-2">
                <div className="flex items-center space-x-4 mt-2">
                  ...
                  <button
                    className="flex items-center bg-primary hover:bg-green-700 text-gray-100 px-4 py-2 rounded text-sm space-x-2 transition duration-100 text-white disabled:bg-slate-400"
                    disabled={isPending}
                    onClick={() => {
                      generatePDF(studentProfile.data, setIsPending);
                    }}
                  >
                    {isPending ? (
                      <svg
                    ...
                    <span className="hidden sm:flex text-white">Download</span>
                  </button>
                </div>
              </div>
            </div>
                    ...
                    <div className="flex w-full border-l-6 border-warning bg-warning bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
                      ...
                      <div className="w-full">
                        ...
                        <p className="leading-relaxed text-[#D0915C]">
                          ...
                          Placement Officer (TPO) as soon as possible. Schedule
                          a meeting with your TPO and bring along all your
                          academic results. Please provide your
                          <b> registration ID ({studentData._id}) </b>
                          for reference. Additionally, ensure to bring any
                          personal proof or documents that you submitted during
                          the placement registration process for final
                          verification.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex w-full border-l-6 border-[#F87171] bg-[#F87171] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
                      ...
                      <div className="w-full">
                        <h5 className="mb-3 font-semibold text-[#B45454]">
                          Your registration form verification has been rejected
                          by the TPO
                        </h5>
                        <ul>
              ...
              <div className="w-full flex flex-col">
                <div className="flex-1 bg-white dark:border-strokedark dark:bg-boxdark rounded-lg shadow-xl p-3 sm:p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 md:gap-2 text-sm md:text-base">
                    <div>
                      <ul className="mt-2 text-gray-700 dark:text-bodydark1">
                    ...
                    <div>
                      <ul className="mt-2 text-gray-700 dark:text-bodydark1">
                        ...
                        <li className="flex border-b border-slate-300 py-2">
                          <span className="font-bold w-24 sm:w-30">Email:</span>
                          <span className="text-gray-700">
                            {studentData.email}
                          </span>
                        </li>
                        <li className="flex border-b border-slate-300 py-2">
                          <span className="font-bold w-24 sm:w-30">Cast:</span>
                          <span className="text-gray-700">
                            {' '}
                            {studentData.cast}
                          </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 md:gap-2 text-sm md:text-base">
                    ...
                    <div>
                      <ul className="mt-2 text-gray-700 dark:text-bodydark1">
                        ...
                        <li className="flex border-b border-slate-300 py-2">
                          <span className="font-bold w-24 sm:w-30">CGPA:</span>
                          <span className="text-gray-700">
                            {studentData.cgpa}
                          </span>
                        </li>
