...
import { loginUserAsync ,selectLoggedInUser,selectPendingstatus,selectSigninError} from './Redux/AuthSlice';
...
const SignIn = () => {
  ...
  useEffect(() => {
    ...
    if (user && showNotification && !error) {
      toast.success('Login Successfull!', {
        duration: 5000,
      });
    }
  }, [error, user, showNotification]);
  return (
    <>
