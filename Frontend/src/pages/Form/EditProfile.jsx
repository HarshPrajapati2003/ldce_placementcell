                  ...
                  <div className="grid grid-cols-2 gap-3 justify-items-stretch">
                    <div>
                      <Link to={'/student-profile'}>
                        <button
                          type="submit"
                          className="w-full rounded bg-slate-200 p-3 font-medium text-black-2 hover:bg-opacity-90 cursor-pointer disabled:bg-slate-400"
                        >
                          Cancel
                        </button>
                      </Link>
                    ...
                    <div>
                      <button
                        type="submit"
                        className="w-full rounded bg-primary p-3 font-medium text-gray hover:bg-opacity-90 cursor-pointer disabled:bg-slate-400"
